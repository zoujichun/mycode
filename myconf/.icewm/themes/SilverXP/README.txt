...
In order to install the theme perform the following actions:
 ...
 - extract the archive SilverXP-1.2.17-double-1.tar.bz2 - it
   will create the icewm/ directory

   cd && tar jxvf SilverXP-1.2.17-double-1.tar.bz2
 ...
 - Patch IceWM-1.2.17 to  enable borderless buttons and
   ...
   cp ~/.icewm/themes/SilverXP-1.2.17-double-1/FreeBSD/patch-src_ybutton.cc files/
   patch < ~/.icewm/themes/SilverXP-1.2.17-double-1/FreeBSD/Makefile.patch
   ...
   cd icewm-1.2.17/src
   patch < ~/.icewm/themes/SilverXP-1.2.17-double-1/Linux/ybutton.cc.patch
   cd ..
